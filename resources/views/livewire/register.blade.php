...
<div class="flex justify-center items-center py-24">
    <div class="w-[40%] bg-white p-8 rounded-md">
        ...
        <form class="space-y-4 mt-8">
            ...
            <button
                class="text-sm font-medium font-poppins bg-highlight py-2 px-5 text-white rounded-md w-full mt-4">Sign
                In</button>
            ...
            <div class="flex items-center text-center justify-center text-gray-500">
                <span>
                    ...
                    <a class="link font-semibold" href="{{route('user-login')}}">Log in</a>
                </span>
            </div>
        </form>
    </div>
